...
class TestManifest():
    ...
    def assert_amd_installer(self,stream):
        ...
        assert "openshift-release-artifacts.apps.ci.l2s4.p1.openshiftapps.com/4.11.0-0.nightly-2022" in stream
        assert "openshift-install-linux-4.11.0-0.nightly-2022" in stream

    def assert_amd_client(self,stream):
        assert "arm64" not in stream
        assert "openshift-release-artifacts.apps.ci.l2s4.p1.openshiftapps.com/4.11.0-0.nightly-2022" in stream
        assert "openshift-client-linux-4.11.0-0.nightly-2022" in stream
    ...
    def assert_arm_installer(self,stream):
        ...
        assert "openshift-release-artifacts-arm64.apps.ci.l2s4.p1.openshiftapps.com/4.11.0-0.nightly-arm64-2022" in stream
        assert "openshift-install-linux-amd64-4.11.0-0.nightly-arm64-2022" in stream

    def assert_arm_client(self,stream):
        assert "arm64" in stream
        assert "openshift-release-artifacts-arm64.apps.ci.l2s4.p1.openshiftapps.com/4.11.0-0.nightly-arm64-2022" in stream
        assert "openshift-client-linux-amd64-4.11.0-0.nightly-arm64-2022" in stream
